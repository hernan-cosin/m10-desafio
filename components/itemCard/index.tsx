...
import { ImageContainer, InfoContainer, ItemCardContainer, Select } from "./styled";
...
export function ItemCard({
    ...
    async function handleBuyClick() {
      ...
      const orderRes = await generateOrder({objectID:objectID, amount:amount.toString(), flavor:flavorsSelectedVal})
    ...
    return (
      <ItemCardContainer>
        ...
        <InfoContainer>
          ...
          <select name="amount" id="amount" onChange={handleChange} style={{display: "block", maxWidth: "50px", margin:"10px 0 0 0",}}>
          ...
          {
            toggleDisableButton?
            <Button disabled className={"card-item-price"} backgroundColor="blue" onClick={handleBuyClick}>
            Comprar
          </Button>
           : <Button className={"card-item-price"} backgroundColor="blue" onClick={handleBuyClick}>
               Comprar
             </Button>
          }
        </InfoContainer>
